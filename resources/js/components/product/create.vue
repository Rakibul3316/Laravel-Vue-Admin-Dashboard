<template>
  <div>
    <div>
      <div class="row">
        <router-link to="/product" class="btn btn-primary ml-3"
              ...
              <div class="col-lg-12">
                <div class="login-form">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4">Insert A Product</h1>
                  </div>
                  ...
                  >
                    ...
                    <div class="form-group">
                      <div class="form-row">
                        <div class="col-md-4">
                          <label for="root"><b>Product Root</b></label>
                          <input
                            type="text"
                            class="form-control"
                            id="root"
                    ...
                    <div class="form-group">
                      <div class="form-row">
                        <div class="col-md-6">
                          <label for="buying_date"><b>Buying Date</b></label>
                          <input
                            type="date"
                            class="form-control"
                            id="buying_date"
...
export default {
  ...
  methods: {
    ...
    productInsert() {
      ...
      fd.append("product_code", this.form.product_code);
      fd.append("category_id", this.form.category_id);
      fd.append("supplier_id", this.form.supplier_id);
      fd.append("root", this.form.root);
      fd.append("buying_date", this.form.buying_date);
      fd.append("buying_price", this.form.buying_price);
